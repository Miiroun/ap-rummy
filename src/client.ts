...
import { Client, clientStatuses, API } from "archipelago.js";
import { InitGame, OnitemsReceived, merges } from "./game"
//import { Client } from "archipelago.js";

(new URL(window.location.href)).searchParams.forEach((x, y) => {
    (<HTMLInputElement>document.getElementById(y)).value = x;
})
...
async function connect_to_server(event) {
    ...
    var url = (<HTMLInputElement>document.getElementById("Hostname")).value + ":" + (<HTMLInputElement>document.getElementById("Port")).value
    var slot = (<HTMLInputElement>document.getElementById("Name")).value
    var password = (<HTMLInputElement>document.getElementById("Password")).value ? (<HTMLInputElement>document.getElementById("Password")).value : null
    var conn_options = {
        password: password,
        "slot_data": true
    }
...
function send_message(e) {
    var messageDIV : any = document.getElementById("Message")
